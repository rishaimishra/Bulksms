            ...
            <div class="col-md-10">
                ...
                <form action="{{route('admin.import.bulkmail')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bulk_email_subject" name="bulk_email_subject" />
                    </div>

                    <div id="user_type_upload_file" class="form-group">
                        <label class="control-label">Upload File</label>
                        <div class="upload-file">
                            <input type="file" id="bulk_email_file" name="bulk_email_file"/>
                            <label for="bulk_email_file">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="bulk_email_attachment" name="bulk_email_attachment" />
                    </div>
